...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post exercises_url, params: { exercise: { file: @exercise.file, title: @exercise.title } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { file: @exercise.file, title: @exercise.title } }
